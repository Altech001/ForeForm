    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between p-4 rounded border border-border">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-sm">Make this a Quiz or Questionnaire</p>
      ...
      {settings.enabled && (
        <div className="space-y-6 pl-2">
          ...
          <div className="space-y-3">
            <p className="text-xs font-semibold">Release Grades</p>
            <RadioGroup value={settings.release_grades} onValueChange={(v) => update("release_grades", v as QuizSettings["release_grades"])} className="space-y-2">
              <div className="flex items-center gap-3 p-3 rounded border border-border hover:bg-accent/20 cursor-pointer">
          ...
          {/* Respondent settings */}
          <div className="space-y-3">
            <p className="text-xs font-semibold ">Respondent Settings</p>
            <div className="space-y-1 border overflow-hidden">
          ...
          {/* Default points */}
          <div className="space-y-3">
            <p className="text-xs font-semibold ">Global Quiz Defaults</p>
