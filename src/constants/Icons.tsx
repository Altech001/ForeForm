 ...
 */
export const FormIcon: React.FC<IconProps> = ({ size = 24, className, ...props }) => (
    <svg
        fill="currentColor"
        height={size}
        width={size}
 ...
 */
export const TemplateIcon: React.FC<IconProps> = ({ size = 24, className, ...props }) => (
    <svg
        fill="currentColor"
        xmlns="http://www.w3.org/2000/svg"
        width={size}
 ...
 */
export const AIIcon: React.FC<IconProps> = ({ size = 24, className, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
 ...
 */
export const ConnectorsIcon: React.FC<IconProps> = ({ size = 25, className, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
